...
const DealSection = () => {
  return (
    <section className="section-deal max-[1200px]:pb-[70px]">
      <div
        className="bg-banner-deal w-full h-[400px] max-[992px]:h-[400px] max-[360px]:h-[450px] relative bg-no-repeat bg-center bg-cover"
        style={{ 
        ...
        <div className="flex flex-wrap justify-between relative items-center mx-auto min-[1600px]:max-w-[1500px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
          <div className="flex flex-wrap w-full">
            <div className="w-full px-[12px]">
              <div className="cr-deal-rightside w-full h-[400px] flex flex-col justify-center max-[992px]:h-[400px] max-[360px]:h-[450px]">
                <div
                ...
                >
                  ...
                  <p className="font-Poppins text-[14px] font-light text-[#7a7a7a] leading-[1.75]">
                    Discover unbeatable prices on high-quality organic food! From farm-fresh fruits and vegetables to pantry staples and snacks, our organic selection is grown without harmful chemicals or pesticides—just pure, natural goodness.
                  </p>
