                      ...
                      <thead>
                        <tr className="border-[1px] border-solid border-[#e9e9e9]">
                          {["Product", "Price", "Quantity", "Total", "Action"].map((heading, idx) => (
                            <th
                              key={idx}
                              className={`p-[15px] text-[#444] text-[15px] font-semibold capitalize align-middle whitespace-nowrap leading-[1] tracking-[0] bg-[#e9e9e9] ${
                                heading === "Quantity" ? "text-center" : "text-left"
                              }`}
                            >
                              {heading}
                            </th>
