...
function PopularProducts() {
  return (
    <>
      ...
      <section className="section-popular mb-[100px] max-[1200px]:mb-[70px]">
        <div className="flex flex-wrap justify-between relative items-center mx-auto min-[1600px]:max-w-[1500px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
          <div className="flex flex-wrap w-full">
            <div className="min-[1400px]:w-[58.33%] min-[992px]:w-[50%] min-[768px]:w-full w-full aos-init aos-animate" data-aos="fade-up" data-aos-duration="2000">
              <div className="cr-twocolumns-product slick-initialized slick-slider">
                ...
                <div aria-live="polite" className="slick-list draggable"><div className="slick-track" role="listbox" style={{
                ...
                }}><div className="slick-slide slick-cloned" style={{ width: '285px' }} data-slick-index="-2" id="" aria-hidden="true" tabindex="-1">
                  ...
                  </div><div className="slick-slide" style={{ width: '285px' }} data-slick-index="0" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide00">
                    <div className="cr-product-card h-full p-[12px] border-[1px] border-solid border-[#e9e9e9] bg-[#fff] rounded-[5px] overflow-hidden flex-col max-[480px]:w-full">
                      <div className="cr-product-image rounded-[5px] flex items-center justify-center relative">
                        <div className="cr-image-inner zoom-image-hover w-full h-full flex items-center justify-center relative overflow-hidden max-[992px]:pointer-events-none" style={{
                          position: 'relative',
                  ...
                  </div><div className="slick-slide" style={{ width: '285px' }} data-slick-index="1" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide01">
                    <div className="cr-product-card h-full p-[12px] border-[1px] border-solid border-[#e9e9e9] bg-[#fff] rounded-[5px] overflow-hidden flex-col max-[480px]:w-full">
                      <div className="cr-product-image rounded-[5px] flex items-center justify-center relative">
                        <div className="cr-image-inner zoom-image-hover w-full h-full flex items-center justify-center relative overflow-hidden max-[992px]:pointer-events-none" style={{
                          position: 'relative',
                  ...
                  </div><div className="slick-slide" style={{ width: '285px' }} data-slick-index="2" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide02">
                    <div className="cr-product-card h-full p-[12px] border-[1px] border-solid border-[#e9e9e9] bg-[#fff] rounded-[5px] overflow-hidden flex-col max-[480px]:w-full">
                      <div className="cr-product-image rounded-[5px] flex items-center justify-center relative">
                        <div className="cr-image-inner zoom-image-hover w-full h-full flex items-center justify-center relative overflow-hidden max-[992px]:pointer-events-none" style={{
                          position: 'relative',
                  ...
                  </div><div className="slick-slide" style={{ width: '285px' }} data-slick-index="3" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide03">
                    <div className="cr-product-card h-full p-[12px] border-[1px] border-solid border-[#e9e9e9] bg-[#fff] rounded-[5px] overflow-hidden flex-col max-[480px]:w-full">
                      <div className="cr-product-image rounded-[5px] flex items-center justify-center relative">
                        <div className="cr-image-inner zoom-image-hover w-full h-full flex items-center justify-center relative overflow-hidden max-[992px]:pointer-events-none" style={{
                          position: 'relative',
                  ...
                  </div><div className="slick-slide slick-current slick-active" style={{ width: '285px' }} data-slick-index="4" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide04">
                    <div className="cr-product-card h-full p-[12px] border-[1px] border-solid border-[#e9e9e9] bg-[#fff] rounded-[5px] overflow-hidden flex-col max-[480px]:w-full">
                      <div className="cr-product-image rounded-[5px] flex items-center justify-center relative">
                        <div className="cr-image-inner zoom-image-hover w-full h-full flex items-center justify-center relative overflow-hidden max-[992px]:pointer-events-none" style={{
                          position: 'relative',
            ...
            <div className="min-[1400px]:w-[41.66%] min-[992px]:w-[50%] min-[768px]:w-full w-full px-[12px] aos-init aos-animate" data-aos="fade-up" data-aos-duration="2000">
              <div className="cr-products-rightbar relative h-full flex items-center max-[992px]:mt-[70px] max-[992px]:block">
                <img src="assets/images/products-rightview.jpg" alt="products-rightview" className="w-full rounded-[5px]" />
                <div className="cr-products-rightbar-content p-[24px] absolute right-[0] top-[0] bottom-[0] flex flex-col items-end justify-center max-[1400px]:max-w-[200px] max-[992px]:h-[calc(100%-70px)]">
                  <h4 className="mb-[0] font-Manrope text-[24px] font-black leading-[1.562] text-[#2b2b2d] text-right max-[1400px]:text-[28px] max-[1200px]:text-[22px] max-[992px]:text-[32px] max-[768px]:text-[28px] max-[576px]:text-[24px] max-[480px]:text-[22px]">Organic &amp; Healthy <br /> Vegetables</h4>
                  <div className="cr-off mt-[20px] flex justify-center">
                    <span className="ml-[7px] px-[6px] font-Manrope text-[20px] font-black leading-[1.2] uppercase text-[#2b2b2d]">25% <code className="text-[14px] text-[#2b2b2d] break-words">OFF</code></span>
                  </div>
                  <div className="rightbar-buttons flex justify-center mt-[30px] max-[576px]:mt-[15px]">
                    <a href="shop-left-sidebar.html" className="cr-button h-[40px] font-bold transition-all duration-[0.3s] ease-in-out py-[8px] px-[22px] text-[14px] font-Manrope capitalize leading-[1.2] bg-[#64b496] text-[#fff] border-[1px] border-solid border-[#64b496] rounded-[5px] flex items-center justify-center hover:bg-[#000] hover:border-[#000]">
                      shop now
                    </a>
                  </div>
                </div>
